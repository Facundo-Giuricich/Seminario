...
>  Si aparece `ECONNREFUSED` al conectar con Redis: verificar que VM1 esté encendida y que `enp0s8` de VM1 tenga la IP `192.168.100.10`
...
>  **Nota importante:** el frontend usa `const API_URL = 'http://192.168.100.20:3000'`, que apunta a la IP interna de VM2. Esto funciona porque el navegador de tu PC llega a VM3 por el reenvío de puertos, y desde dentro de la red interna VM3 puede alcanzar a VM2 directamente.
